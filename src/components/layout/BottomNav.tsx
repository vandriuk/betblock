...
export type TabId = 'dashboard' | 'inventory' | 'products' | 'production' | 'orders' | 'sales' | 'expenses'
...
export function BottomNav({ activeTab, onTabChange, onMoreClick }: BottomNavProps) {
  const isMoreActive = activeTab === 'products' || activeTab === 'sales' || activeTab === 'expenses'
